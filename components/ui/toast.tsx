...
>(({className, ...props}, ref) => (
    <ToastPrimitives.Viewport
        ref={ref}
        className={cn(
            "fixed  z-[100]  w-full  p-4 top-0  right-0 flex-col md:max-w-[420px]",
            className
        )}
        {...props}
    />
...
const toastVariants = cva(
    ...
    "data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-top-full",
    {
        variants: {
            variant: {
                default:
                    "border bg-background text-foreground dark:border-zinc-800",
                success:
                    "border-success_300 bg-[hsl(var(--success))] text-[hsl(var(--success-foreground))]",
                error:
                    "border-error_200 bg-[hsl(var(--error))] text-[hsl(var(--error-foreground))]",
                destructive:
                    "border-destructive bg-[hsl(var(--destructive))] text-[hsl(var(--destructive-foreground))]",
            },
        },
        defaultVariants: {
            variant: "default",
