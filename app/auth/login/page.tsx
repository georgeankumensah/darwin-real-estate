...
const Login = () => {
    ...
    return (
        <section>
            ...
            <div
                className=" bg-black h-[200px] w-full fixed z-10 bottom-0 [mask-image:url('https://assets.jijistatic.net/static/svg/footer/footer-ghana-new.svg');] [mask-repeat:no-repeat] [mask-size:contain] [mask-position:bottom]"/>
        </section>
    );
};
